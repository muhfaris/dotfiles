return function(_, _)
  ...
  local signs = {
    ...
    { name = "DapStopped",             text = get_icon "DapStopped",             texthl = "" },
    { name = "DapBreakpoint",          text = get_icon "DapBreakpoint",          texthl = "" },
    { name = "DapBreakpointRejected",  text = get_icon "DapBreakpointRejected",  texthl = "" },
    { name = "DapBreakpointCondition", text = get_icon "DapBreakpointCondition", texthl = "" },
    { name = "DapLogPoint",            text = get_icon "DapLogPoint",            texthl = "" },
  }
